...
@Component({
  selector: 'app-busqueda-tecnico',
  templateUrl: './busqueda-tecnico.component.html',
  styleUrls: ['./busqueda-tecnico.component.css']
})
export class BusquedaTecnicoComponent implements OnInit {
  ...
  displayedColumns = ['nombre', 'almacen', 'email', 'telefono', 'celular'];
