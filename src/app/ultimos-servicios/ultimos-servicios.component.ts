...
@Component({
  selector: 'app-ultimos-servicios',
  templateUrl: './ultimos-servicios.component.html',
  styleUrls: ['./ultimos-servicios.component.css']
})
export class UltimosServiciosComponent implements OnInit {

  displayedColumns = ['folio', 'ibs', 'cliente', 'estatus', 'fecha', 'prediagnostico', 'asignacion'];
